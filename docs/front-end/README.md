# Front-End Patterns & Components

Documentation for reusable front-end patterns, components, and design implementations.
...
- [Scroll-Lock Exit Transition](./SCROLL_LOCK_EXIT_TRANSITION.md) - **Fix for content abruptly disappearing when scroll-lock ends**
- [Scroll-Lock Content Layout](./SCROLL_LOCK_CONTENT_LAYOUT.md) - **Fix for overlapping elements inside scroll-lock sections**
