...
Transform user request into structured production brief:
...
- **Working Title**: [Title]
- **Director**: Visual Essay Director
- **Date Initiated**: [Date]
...
| Publication Approval | [Date] | Visual Essay Director |
| Deployment | [Date] | Visual Essay Director |
```
...
- **Visual Essay Director**: Pipeline management, quality gates, publication approval
...
**Division of Responsibilities**
- **Visual Essay Director**: Source requirements, quality assessment, gap identification
...
**Division of Responsibilities**
- **Visual Essay Director**: Audit invocation, fix approval, certification acceptance
...
```
Using your assigned role as Visual Essay Director, initiate production 
...
```
Using your assigned role as Visual Essay Director, provide status update 
on the visual essay "[TITLE]" currently in production.
```

**For Publication Approval:**
```
Using your assigned role as Visual Essay Director, conduct final 
