...
export const visualEssays: VisualEssay[] = [
  ...
  },
  {
    ...
    subtitle: "A Cinematic History of Basketball's Invention",
    description: "Winter 1891, Springfield, Massachusetts. A Canadian teacher, a ladder, a soccer ball, and an idea that changed the world. Experience the mythic story of basketball's birth through museum-grade visual storytelling.",
    category: "History",
    readTime: "15 min",
  ...
  },
  {
    ...
    number: "34",
    title: "The Ledger",
    subtitle: "How Humanity Learned to Trust an Idea",
    description: "From cowrie shells to cryptocurrency, explore 5,000 years of money's evolution. Discover how worthless objects became the foundation of civilization through trust, standardization, and abstraction.",
    category: "History",
    readTime: "15 min",
    href: "/essays/visual/the-ledger",
    tags: ["money", "currency", "history of money", "cowrie shells", "coins", "Lydia", "paper money", "Bitcoin", "cryptocurrency", "fiat", "economics", "gold standard"],
  },
  {
    id: "the-great-fire",
    number: "35",
  ...
  },
  {
    ...
    subtitle: "How Digital Trust Transformed Money",
    description: "From cypherpunk dreams to trillion-dollar networks. Explore the origins of P2P money, the mechanics of miners, and how blockchains work—through scroll-locking animations and intuitive metaphors. Featuring David Chaum, Wei Dai, Satoshi Nakamoto, and the pioneers who reimagined trust itself.",
    category: "Technology",
    readTime: "25 min",
    href: "/essays/visual/the-blockchain",
    tags: ["blockchain", "bitcoin", "cryptocurrency", "Satoshi Nakamoto", "peer-to-peer", "mining", "cryptography", "digital currency", "cypherpunk", "David Chaum", "Wei Dai", "Nick Szabo", "Hal Finney", "proof of work", "decentralization", "ledger", "P2P money"],
  },
  {
    id: "ledger-of-trust",
    number: "37",
    title: "The Ledger of Trust",
    subtitle: "A Visual Journey Through the Blockchain",
    description: "An immersive, scroll-driven visual essay that demystifies blockchain through cinematic storytelling, intuitive metaphors, and sophisticated micro-interactions. From the cypherpunk manifesto to Satoshi's disappearance—discover how a chain of blocks rebuilt trust in a trustless world.",
    category: "Technology",
    readTime: "18 min",
    href: "/essays/visual/ledger-of-trust",
    tags: ["blockchain", "bitcoin", "cryptocurrency", "Satoshi Nakamoto", "cypherpunk", "David Chaum", "Wei Dai", "Nick Szabo", "Hal Finney", "Eric Hughes", "Adam Back", "proof of work", "mining", "cryptography", "decentralization", "consensus", "genesis block", "double spend"],
  },
  {
