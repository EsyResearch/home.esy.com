...
export const visualEssays: VisualEssay[] = [
  ...
  },
  {
    id: "silk",
    number: "89",
    title: "Silk — A Global History",
    subtitle: "The Thread That Connected Worlds",
    description: "An immersive visual essay tracing the 5,000-year journey of silk — from its mythical origins in ancient China through the great Silk Roads, Byzantine espionage, European luxury, and modern innovation. Featuring extensive photography, interactive migration maps, and era-shifting design.",
    category: "History",
    readTime: "2 min",
    href: "/essays/silk",
    draft: true,
  ...
  },
  {
    ...
    description: "A visual essay spanning 5,000 years of sword-making, sword-fighting, and sword-meaning across Japanese, European, and Islamic traditions. Features metallurgy-derived design research, blade anatomy diagrams, and cross-cultural collision narratives.",
    category: "History",
    readTime: "15 min",
  ...
  {
    id: "the-bitter-history-of-chocolate",
    number: "90",
    title: "The Bitter History of Chocolate",
    subtitle: "From the Blood of Gods to the Sweat of Children",
    description: "A 3,500-year visual history of cacao — from Olmec sacred drink to $130 billion global industry. Five-movement cinematic structure, 6 interactive visualizations, 12 verified academic sources.",
    category: "History",
    readTime: "9 min",
  ...
  {
    id: "the-speed-of-everything",
    number: "88",
    title: "The Speed of Everything",
    subtitle: "A Logarithmic Journey Through Velocity",
    description: "An interactive visual essay exploring the vast logarithmic scale of velocities — from continental drift to the speed of light. Features 6 interactive visualizations with scroll-driven animations and verified Tier 1 scientific data.",
    category: "Science",
    readTime: "6 min",
  ...
  },
  {
    ...
    subtitle: "From Ocean to Quantum",
    description: "An interactive visual essay exploring the universal pattern of waves — from ocean waves to sound, light, interference, standing waves, and quantum wave functions. Built on 14 Tier-1 physics sources with 7 interactive visualizations.",
    category: "Science",
    readTime: "13 min",
  ...
  },
  {
    ...
    description: "From ancient Greek \u03c6\u03c9\u03bd\u03ae ('voice') through telephone, phonograph, and saxophone to the smartphone era \u2014 a visual etymology of the most ubiquitous noun of the 21st century.",
    category: "Education & Writing",
    readTime: "25 min",
    href: "/essays/etymology/the-word-phone",
    tags: ["etymology", "phone", "Greek", "linguistics", "Bell", "telephone", "smartphone", "phonograph", "microphone", "saxophone", "semantic fossilization", "visual essay"],
    visualStyle: "illustrated",
    heroImage: "https://images.esy.com/essays/the-word-phone/the-word-phone-og.027ce054f6.webp",
  },
  {
  ...
  },
  {
    ...
    description: "KNM-WT 15000 is the most complete early Homo skeleton and the clearest window into when our body plan truly emerged. From a mandibular abscess to Out-of-Africa migration, this essay traces the first draft of the modern human body through 108 bones, 14 visualizations, and 1.53 million years of evidence.",
    category: "Science",
    readTime: "49 min",
    ...
    tags: ["Turkana Boy", "KNM-WT 15000", "Homo ergaster", "Homo erectus", "paleoanthropology", "human evolution", "Lake Turkana", "Nariokotome", "body plan", "thermoregulation", "locomotion"],
    visualStyle: "photorealistic",
    spec: "turkana-boy",
    buildModel: "claude-opus-4.6",
    canonicalBuild: "spec-r2",
  },
  {
