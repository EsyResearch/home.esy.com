...
export default function SchoolVideosClient() {
  ...
  const sectionPadding = isMobile ? "0 1rem" : isTablet ? "0 1.5rem" : "0 2rem";
    ...
    >
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          >
            Workflow <span style={{ color: theme.accent }}>Tutorials</span>
          </h1>
          ...
          >
            Step-by-step video guides for every Esy workflow template. Watch how
            structured workflows turn your ideas into publishable artifacts.
          </p>
        </div>
      </section>
