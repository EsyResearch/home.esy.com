...
import { GlossaryTermDetail } from '@/types';

// Sample term data - in a real app, this would come from an API or database
...
const GlossaryTermPage = async ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  const term = getTermData(id);

  return <GlossaryTermPageClient term={term} />;
};
