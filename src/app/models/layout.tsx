...
export default function ModelsLayout({
  ...
  useEffect(() => {
    ...
    if (isDark) {
      document.body.classList.add('models-dark');
      document.body.classList.remove('models-light');
    } else {
      document.body.classList.add('models-light');
      document.body.classList.remove('models-dark');
    }
  }, []);
  ...
  const toggleTheme = () => {
    ...
    if (newIsDark) {
      document.body.classList.add('models-dark');
      document.body.classList.remove('models-light');
      localStorage.setItem('theme-models', 'dark');
    } else {
      document.body.classList.add('models-light');
      document.body.classList.remove('models-dark');
      localStorage.setItem('theme-models', 'light');
    }
