  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Popular Categories Section (only show when no search/filters) */}
        {!searchQuery && activeCategory === 'all' && !activeSubcategory && !activeDifficulty && (
          <section style={{ marginBottom: 'clamp(3rem, 6vh, 4rem)' }}>
            <h2
              style={{
            ...
            >
              {[
                ...
                },
                {
                  ...
                  description: 'Anthropic Claude optimized',
                ...
                <Link
                  ...
                  onMouseLeave={(e) => {
                    e.currentTarget.style.borderColor = elevatedDarkTheme.border;
