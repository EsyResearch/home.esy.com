...
const SHOWCASE_ESSAYS: ShowcaseEssay[] = [
  {
    ...
    heroImage: '/images/manhattan-project/groves-oppenheimer.jpg',
    size: 'featured',
  },
  {
    id: 'the-great-fire',
    ...
    heroImage: '/images/great-fire/great-fire-london-1675.jpg',
    size: 'featured',
  },
  {
    id: 'thinking-machine',
    title: 'The Thinking Machine',
    subtitle: 'A Visual History of AI',
    category: 'Technology',
    categoryColor: '#3B82F6',
    readTime: '25 min',
    href: '/essays/visual/the-thinking-machine',
    heroImage: '/images/thinking-machine/turing-1951.jpg',
    size: 'standard',
  },
  {
    id: 'the-fork',
    ...
    heroImage: '/images/essays/fork/hero-byzantine-fork.jpg',
    size: 'standard',
  },
];
